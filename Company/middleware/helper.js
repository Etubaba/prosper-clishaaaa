...
//       cb(null, (Math.random() + 1).toString(36).substring(4) + "-" + Date.now()+".jpg")
//     }
// });
...
const s3BucketStorage = multerS3({
    ...
    key: function (req, file, cb) {
        cb(null, (Math.random() + 1).toString(36).substring(4) + "-" + Date.now()+ path.extname(file.originalname))
    }
})
