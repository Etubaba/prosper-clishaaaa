const comfirmPasswordTemplate = (url) => {
  return `<!DOCTYPE html>
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class style="font-size: 12px; font-family: Arial, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #2b3582; line-height: 1.2;">
																		<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="font-size:26px;"><em><span style><strong>confirm password</strong></span></em></span></p>
																	</div>
																</div>
															</td>
														</tr>
