...
db.models.TempSubAdmins = require('./TempSubAdmins.js')(
  sequelize,
  Sequelize.DataTypes
)
...
db.models.ClishaRecord = require('./ClishaRecord')(
  sequelize,
  Sequelize.DataTypes
)

db.models.Questionnaire = require('./Questionnaire')(
  sequelize,
  Sequelize.DataTypes
)

db.models.QuestionnaireCategory = require('./QuestionnaireCategory')(
  sequelize,
  Sequelize.DataTypes
)
...
;(async () => {
  try {
    ...
    console.log('<<<<<  Syncing Company server to  Database >>>>>')
  } catch (error) {
    console.error('Unable to connect to the database:', error)
  }
})()
